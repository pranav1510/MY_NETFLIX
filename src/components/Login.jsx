    ...
    return(
        <div className="relative">
            <div className="absolute -z-10 brightness-50">
                <img src="https://assets.nflxext.com/ffe/siteui/vlv3/7968847f-3da9-44b3-8bbb-13a46579881f/web/IN-en-20250609-TRIFECTA-perspective_32b70b51-20d4-46db-8a1a-3d5428be5f0e_medium.jpg" alt="Background Img" />
            </div>
            <div className="px-40">
                <div className="w-48">
